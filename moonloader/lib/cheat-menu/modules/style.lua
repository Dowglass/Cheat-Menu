...
function StylerColorPicker(style,i)
    ...
    if imgui.ColorEdit4("##Cor", float,imgui.ColorEditFlags.AlphaBar) then
...
function module.StyleEditor()
    ...
    if fcommon.BeginTabBar('StyleBar') then
        if fcommon.BeginTabItem('Bordas') then
            imgui.Columns(2,nil,false)

            style.ChildBorderSize = StylerCheckbox("Child border",style.ChildBorderSize)
            style.FrameBorderSize = StylerCheckbox("Bordas",style.FrameBorderSize)
        
            imgui.NextColumn()

            style.PopupBorderSize = StylerCheckbox("Borda do pop-up",style.PopupBorderSize)
            style.WindowBorderSize = StylerCheckbox("Borda da janela",style.WindowBorderSize)
        ...
        if fcommon.BeginTabItem('Tamanhos') then
            ...
            style.ItemInnerSpacing = StylerSliderFloat2("Espaçamento interno do item",style.ItemInnerSpacing,0.0,20.0)
            style.ItemSpacing = StylerSliderFloat2("Espaçamento de item",style.ItemSpacing,0.0,20.0)
            ...
            style.FrameRounding = StylerSliderFloat("Arredondamento de quadro",style.FrameRounding,0.0,12.0)
            style.GrabRounding = StylerSliderFloat("Arredondamento da barra",style.GrabRounding,0.0,12.0)
            style.PopupRounding = StylerSliderFloat("Arredondamento do pop-up",style.PopupRounding,0.0,12.0)
            style.ScrollbarRounding = StylerSliderFloat("Arredondamento da barra de rolagem",style.ScrollbarRounding,0.0,12.0)
            style.WindowRounding = StylerSliderFloat("Arredondamento da janela",style.WindowRounding,0.0,12.0)
