...
function module.DrawEntries(identifier,draw_type,func_on_left_click,func_on_right_click,func_get_name,data_table,const_image_height,const_image_width)
    ...
    fcommon.DropDownListStr("##Lista",draw_entries_data[identifier].entry_table,draw_entries_data[identifier].selected,
    function(key,val) 
    ...
    draw_entries_data[identifier].filter:Draw("##Filtrar")
